...
const FVector4d FVector4d::ZeroVector(0.0);
const FVector4d FVector4d::OneVector(1.0);
// Float Vector4 Static Consts
const FVector4f FVector4f::ZeroVector(0.0f);
const FVector4f FVector4f::OneVector(1.0f);

// Double Vector3 Static Consts
const FVector3d FVector3d::ZeroVector(0.0);
const FVector3d FVector3d::OneVector(1.0);
